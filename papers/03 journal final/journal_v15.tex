...
\begin{table}[!h]
	...
	\begin{tabular}{l c l}
		...
		{$ \eta^{\mathrm{ch}}$} & - & {charging  efficiency}\\
		{$ \eta^{\mathrm{ds}}$} & - & {discharging efficiency}\\
...
\begin{figure}[t]
	\centering
	\includegraphics[width=1\linewidth]{figures/simB_0402_pt1_v3a}
...
\begin{figure}[t]
	\centering 
	%\hspace{-17pt}
	\includegraphics[width=1\linewidth]{figures/simB_0402_pt2_v4a}
...
\begin{figure}[t]
	\centering 
	%\hspace{-17pt}
	\includegraphics[width=1\linewidth]{figures/simB_0402_pt3_v2a}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=1\linewidth]{figures/simEF2.eps}
