...
%
The next proposition shows the global convergence of Algorithm 1 to a variational GNE of the proposed P2P market game. \blue{Due to space limitations, we provide only a sketch of the proof that is mainly based on the technical results in \cite[Theorem~2]{belgioioso2020semi}.}
...
\item \blue{Algorithm 1 can be cast as a proximal-point method, opportunely preconditioned to distribute the computation among the prosumers.
%
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.92\linewidth]{figures/b0a.eps}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.92\linewidth]{figures/simB_0402_pt1_v3a}
...
\begin{figure}[t]
	\centering 
	%\hspace{-17pt}
	\includegraphics[width=0.92\linewidth]{figures/simB_0402_pt2_v4a}
...
\begin{figure}[t]
	\centering 
	%\hspace{-17pt}
	\includegraphics[width=0.92\linewidth]{figures/simB_0402_pt3_v2a}
...
\begin{figure}[!t]
	\centering
	\includegraphics[width=0.92\linewidth]{figures/simC_37_v2.eps}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.92\linewidth]{figures/simEF2_GB3.eps}
