...
\Procedure{Communication with trading partners and DSO}{}
...
\Procedure{Dual variable (reciprocity constraints) update}{}
\ForAll{ $ j \in \mc N_i$}
\State
...
\Procedure{Physical variables update}{}
\State
$a_{N+1}(k+1) = \col \left( 
	\left\{
	\0,\0,-\mu^{\text{tg}}(k), 
...
\Procedure{Dual variable (grid constraints) update}{}
\State
...
\Procedure{Dual variable (local power balance of bus $y$)}{}
...
\Procedure{Dual variable (trading with the main grid)}{}
\State
...
\Procedure{Broadcast to prosumers}{}
\State
