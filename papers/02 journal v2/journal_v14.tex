...
%
\edit{
The main advantage of our decentralized market design is that its equilibria are not only economically optimal but also strategically stable, i.e., no prosumer has an incentive in unilaterally deviate, operationally safe and reliable, i.e., the network operational requirements are met, and socially fair, i.e., the marginal loss for satisfying the grid constraints is the same for each prosumer. 
%
%
