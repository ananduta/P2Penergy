...
\caption{Distributed P2P Markets Clearing Mechanism \red{[include charging and discharging]}}
\label{alg:alg1}
\begin{algorithmic}[1]
\small
...
\State $\eta_i(k+1)= p^{\text{d}}_i-p^{\text{di}}_i(k+1)- p^{\text{st}}_i(k+1)$
