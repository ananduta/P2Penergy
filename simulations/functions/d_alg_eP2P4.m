...
% 12/11/2020
        ...
        while 1
           ...
           for i=1:np.n
                ...
                res1(t+1)= res1(t+1) + (s.u{i}(:,t+1)-s.u{i}(:,t))'*(s.u{i}(:,t+1)-s.u{i}(:,t));
            end
...
%            s = projDSO_comp(s,np,t);                                      
            ...
            for y=1:np.b
                ...
                res1(t+1)= res1(t+1) + (s.u_DSO{y}(:,t+1)-s.u_DSO{y}(:,t))'*(s.u_DSO{y}(:,t+1)-s.u_DSO{y}(:,t));
            end
