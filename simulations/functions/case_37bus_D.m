...
np.N_b{13} = double.empty;
np.N_b{14} = double.empty;
np.N_b{15} = double.empty;
np.N_b{16} = double.empty;
np.N_b{17} = 11;
np.N_b{18} = double.empty;
np.N_b{19} = double.empty;
np.N_b{20} = 12;
np.N_b{21} = double.empty;
np.N_b{22} = double.empty;
np.N_b{23} = [13,14];
...
np.st_un = randi([0 1], n,1);%zeros(n,1);
